  ...
  Widget build(BuildContext context) {
    return Column(
      children: <Widget>[
        ...
        validationMessage.isNotEmpty ? Text(validationMessage, style: const TextStyle(color: Colors.red)) : Container()
      ],
    );
  }
}
...
class LoginTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: TextField(decoration: const InputDecoration.collapsed(hintText: 'User Id'), controller: controller),
    );
  }
}
